...
export function FontList({
  ...
  return (
    <div className="space-y-5">
      <FontGroup active={active} fonts={monoFonts} label="Mono" onSelect={onSelect} />
      <FontGroup active={active} fonts={sansFonts} label="Sans" onSelect={onSelect} />
    </div>
  );
}
        ...
        {fonts.map((f) => {
          ...
          return (
            ...
            >
              ...
              {selected && (
                <Check className="shrink-0 text-primary" size={14} weight="duotone" />
              )}
            </button>
          );
        })}
