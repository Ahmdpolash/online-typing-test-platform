        ...
        return (
          ...
          >
            ...
            <div className="flex h-6 w-full overflow-hidden rounded-lg ring-1 ring-black/5">
              <span className="flex-1" style={{ backgroundColor: t.colors[0] }} />
              <span className="flex-1" style={{ backgroundColor: t.colors[1] }} />
              <span className="flex-1" style={{ backgroundColor: t.colors[2] }} />
            </div>
