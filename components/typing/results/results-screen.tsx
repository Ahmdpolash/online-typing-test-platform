...
export function ResultsScreen({ stats, onRestart, onNext }: ResultsScreenProps) {
  const {
    ...
    consistency, elapsedSeconds, correctedErrors,
    mode, modeDetail, wpmHistory,
  } = stats;
      ...
      >
        <div className="flex flex-col items-center gap-3 px-2 text-center">
          ...
          <p className="max-w-md text-muted-foreground text-sm leading-relaxed">
            ...
            This often happens if the timer ran out before you typed, or the
            test ended right after it started.
          </p>
  ...
  return (
    <div className="flex w-full flex-col gap-5 md:mx-auto md:max-w-5xl md:gap-6">
      ...
      <div className="flex items-center justify-center gap-8 md:gap-12">
        ...
        >
          <KeyStat animated label="consistency" suffix="%" value={consistency} />
        </motion.div>
