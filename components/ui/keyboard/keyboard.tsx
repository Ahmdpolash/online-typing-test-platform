        ...
        <div className="h-[278px] rounded-[5px] rounded-t-[8px] border border-black bg-black/80 dark:border-zinc-500 dark:bg-zinc-700">
          <div className="-translate-y-1 -space-y-1 overflow-hidden rounded-[5px]">
            <Row>
              ...
              <Key keyCode={KEYCODE.F1}><IconBrightnessDown className="size-[10px]" /><span>{"F1"}</span></Key>
              <Key keyCode={KEYCODE.F2}><IconBrightnessUp className="size-[10px]" /><span>{"F2"}</span></Key>
              <Key keyCode={KEYCODE.F3}><IconLayoutDashboard className="size-[10px]" /><span>{"F3"}</span></Key>
              <Key keyCode={KEYCODE.F4}><IconSearch className="size-[10px]" /><span>{"F4"}</span></Key>
              <Key keyCode={KEYCODE.F5}><IconMicrophone className="size-[10px]" /><span>{"F5"}</span></Key>
              <Key keyCode={KEYCODE.F6}><IconMoon className="size-[10px]" /><span>{"F6"}</span></Key>
              <Key keyCode={KEYCODE.F7}><IconPlayerTrackPrev className="size-[10px]" /><span>{"F7"}</span></Key>
              <Key keyCode={KEYCODE.F8}><IconPlayerSkipForward className="size-[10px]" /><span>{"F8"}</span></Key>
              <Key keyCode={KEYCODE.F9}><IconPlayerTrackNext className="size-[10px]" /><span>{"F9"}</span></Key>
              <Key keyCode={KEYCODE.F10}><IconVolume3 className="size-[10px]" /><span>{"F10"}</span></Key>
              <Key keyCode={KEYCODE.F11}><IconVolume2 className="size-[10px]" /><span>{"F11"}</span></Key>
              <Key keyCode={KEYCODE.F12}><IconVolume className="size-[10px]" /><span>{"F12"}</span></Key>
              <Key keyCode={KEYCODE.F13}><IconFrame className="size-[10px]" /></Key>
              <Key keyCode={KEYCODE.Delete}>{"del"}</Key>
              <Key keyCode={KEYCODE.F14}><IconBulb className="size-[12px]" /></Key>
            </Row>
            ...
            <Row>
              ...
              <Key keyCode={KEYCODE.Backspace} width={100}><IconArrowNarrowLeft className="size-[12px]" /></Key>
            ...
            <Row>
              ...
              <Key keyCode={KEYCODE.ArrowUp}><IconChevronUp className="size-[12px]" /></Key>
            ...
            <Row>
              ...
              <Key keyCode={KEYCODE.MetaLeft} width={62}><IconCommand className="size-[12px]" /></Key>
              <Key keyCode={KEYCODE.Space} width={314} />
              <Key keyCode={KEYCODE.MetaRight}><IconCommand className="size-[12px]" /></Key>
              <Key keyCode={KEYCODE.Fn}>{"fn"}</Key>
              <Key keyCode={KEYCODE.ControlRight}>{"ctrl"}</Key>
              <Key keyCode={KEYCODE.ArrowLeft}><IconChevronLeft className="size-[12px]" /></Key>
              <Key keyCode={KEYCODE.ArrowDown}><IconChevronDown className="size-[12px]" /></Key>
              <Key keyCode={KEYCODE.ArrowRight}><IconChevronRight className="size-[12px]" /></Key>
            </Row>
          </div>
        </div>
      </div>
...
function DualKey({
  ...
  return <Key keyCode={keyCode} width={width}>{normal}</Key>;
}
